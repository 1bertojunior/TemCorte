...
INSERT INTO city (name, initials, fk_state) VALUES ('Belém do  Piaui', 'BP', 1);

UPDATE city SET name = "Belém do Piauí" WHERE name = "Belém do Piaui";

SELECT * FROM city WHERE name = "Belém do Belém do Piaui";

SELECT * FROM city WHERE name = "Belém do Belém do Piauí";
...
SELECT * FROM day_active WHERE fk_city = 1;

SELECT * FROM day_active WHERE fk_city = 2;

SELECT d.name FROM day_active AS da INNER JOIN day AS d ON (d.id = da.fk_day) WHERE da.fk_city = 1; 

SELECT d.name FROM day_active AS da INNER JOIN day AS d ON (d.id = da.fk_day) WHERE da.fk_city = 2; 
...
SELECT t.name FROM time_active AS ta INNER JOIN time AS t ON (ta.fk_time = t.id) WHERE fk_day = 1;

SELECT t.name FROM time_active AS ta INNER JOIN time AS t ON (ta.fk_time = t.id) WHERE fk_day = 3 AND ta.fk_city = 2;
